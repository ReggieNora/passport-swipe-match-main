...
const TextRotate = forwardRef<TextRotateRef, TextRotateProps>(
  (
    ...
    // Enhanced function to split text into characters with better support for unicode and emojis
    const splitIntoCharacters = (text: string): string[] => {
      // Check if Intl.Segmenter is available in the environment
      if (typeof Intl !== "undefined" && "Segmenter" in Intl && (Intl as any).Segmenter) {
        try {
